...
const makeDecisionWrap = () => {
  function makeDecision(fuelRemaining, distance, fuelConsumption) {
    ...
    return drivingRange * 100 >= distance
...
const getGuestsCountWrap = () => {
  ...
  console.log(getGuestsCount("12"));
  console.log(Number(Math.random().toFixed(2)));
};

const getRandomNumberWrap = () => {
...
const splitStringPairsRefinedWrap = () => {
  function splitString(str) {
    if (str.length % 2 !== 0) {
      str += "_";
    }
...
const infiniteForCountdownWrap = () => {
  let i = 0;
  let j = 1;
...
const halvingWhileTrueCountWrap = () => {
  let n = 256;
  let count = 0;
...
const randomUntilThresholdWrap = () => {
  let n = Math.random();
...
const localeCompareWrap = () => {
  const name1 = "їжак";
  const name2 = "яблуко";
  console.log(name1.localeCompare(name2) > 0);
...
const isJumpingFirstAttemptWrap = () => {
...
const isLetterWrap = () => {
  ...
  console.log(isLetter("a"), isLetter("1"));
};
...
const makeAbbrWrap = () => {
  ...
  console.log(makeAbbr("Mate academy"));
  console.log("\x20/"); // ' ' - spacing
};

const stringSearchMethodsWrap = () => {
...
const scrollingTextRefinedWrap = () => {
  function scrollingText(word) {
    const result = [];
...
const functionsIntroWrap = () => {
  ...
  console.log(square(3), square2(3), getString());
};

const switchCaseBasicsWrap = () => {
  const count = 2;
...
const findCalculationTypeWrap = () => {
  ...
  console.log(findCalculationType(2, 3, 5));
};

const switchTrueWrap = () => {
  function getName(count) {
    switch (true) {
      case count < 2:
        return "One";
...
const typeConversionTruthyFalsyWrap = () => {
...
const reinventAndOrWrap = () => {
  const or = (a, b) => (a ? a : b);

  console.log(or(3, 3), or(3, 4), or(4, 3), or(4, 4));

  const and = (a, b) => (!a ? a : b);

  console.log(and(3, 3), and(3, 4), and(4, 3), and(4, 4));

  console.log(0 || (null && 13) || false);
...
const canTheyBookWrap = () => {
  function canTheyBook(adultsCount = 0, childrenCount = 0, babiesCount = 0) {
    const withoutBabiesCapability =
      !babiesCount && adultsCount + childrenCount <= 8;
    const withBabiesCapability =
      babiesCount > 0 &&
...
const recommendRoomWrap = () => {
  ...
  console.log(recommendRoom(2, 3, 1));
};

const printInfoPositionalArgsWrap = () => {
...
const printUserInfoObjectArgWrap = () => {
  const user1 = {
    firstName: "Misha",
    lastName: "Hrynko",
    age: 39,
...
const computedKeysBasicWrap = () => {
  ...
  console.log(
    `Hi ${user3[namePrefix + "Name"]} ${user3[surnamePrefix + "Na" + "me"]}`,
  );
...
const editingAddingDeletingPropsWrap = () => {
...
const getOutdatedWrap = () => {
  ...
  console.log(getOutdated(robots, 14));
};

const propertyExistenceChecksWrap = () => {
  const user = {
    firstName: "Misha",
    lastName: "Hrynko",
    age: 39,
...
const objectKeysValuesEntriesWrap = () => {
  const user = {
    firstName: "Misha",
    lastName: "Hrynko",
    age: 39,
...
const getTriathlonDistanceWrap = () => {
...
const wordIncludesSliceIndexOfWrap = () => {
  let word = "word";
  console.log(word.includes("o", 0), word.slice(), word.indexOf("ke"));
};

const funcCheckDefaultParamWrap = () => {
  const funcCheck = (param) => param;
  console.log(funcCheck());
};

const colorStonesWrap = () => {
  ...
  console.log(colorStones("aabbccdd"));
};

const countNextSmallerWrap = () => {
...
const getProductIdWrap = () => {
  ...
  console.log(
    "http://www.exampleshop.com/letter-p-book-stand-p-192837-11112011.html".lastIndexOf(
      "-p-",
    ),
  );
};

const getLeadersWrap = () => {
...
const getArrayProductWrap = () => {
  ...
  console.log(getArrayProduct([1, 2, 3, 4]));
};

const getRowWeightsFirstAttemptWrap = () => {
...
const getRowWeightsRefinedWrap = () => {
  function getRowWeights(people) {
    let result = [0, 0];
...
const referenceEqualityWrap = () => {
  ...
  console.log(me.age, guest.age);
};

const referenceIncrementWrap = () => {
  const myFriend = {
    name: "John",
    age: 25,
  };
